...
'<div class=\"segmented-control is-grid seg-3 u-mb10\" data-segmented-control=\"account-rebalance\" aria-label=\"Cara menyesuaikan porsi\">'
+'<button type=\"button\" class=\"segmented-choice\"'+(pending.method==='proporsional'?' active':'')+' data-action=\"AccOwners.setRebalanceMethod\" data-args=\'[\"proporsional\"]\'>Proporsional</button>'
+'<button type=\"button\" class=\"segmented-choice\"'+(pending.method==='largest'?' active':'')+' data-action=\"AccOwners.setRebalanceMethod\" data-args=\'[\"largest\"]\'>Terbesar</button>'
+'<button type=\"button\" class=\"segmented-choice\"'+(pending.method==='manual'?' active':'')+' data-action=\"AccOwners.setRebalanceMethod\" data-args=\'[\"manual\"]\'>Manual</button>'
+'</div>'+
manualSelectHtml+
