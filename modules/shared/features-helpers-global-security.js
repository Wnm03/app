...
const APP_BUILD_VERSION = 'audit-dashboard-servis-reminder-dead-files-sync-1698';
const PRODUCTION_BUILD_SYNCED_VERSION = 'audit-dashboard-servis-reminder-dead-files-sync-1698';
let D = {
