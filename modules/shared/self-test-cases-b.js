...
let callCount=0;
if(typeof globalThis!=='undefined')globalThis.__kwSaveImmediateObserver=function(){callCount++;};
try{
...
const coreOk = r.sync.ok && r.ownerIdConsistency.ok && r.debtNameStaleness.ok && r.accountSync.ok && r.transactionOwnerRefs.ok && r.syncInvariants.ok;
