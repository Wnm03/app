...
let _activeBudgetTabBtn=null;
document.querySelectorAll('.budget-tab-btn').forEach(b=>{const active=b.dataset.tab===tab;b.classList.toggle('active',active);if(active)_activeBudgetTabBtn=b;});
if(typeof scrollTabBarIntoView==='function') scrollTabBarIntoView(_activeBudgetTabBtn);
