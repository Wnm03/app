...
test('Aset.totalValue() — kalau OwnershipEngine tidak dimuat, fallback hitung semua aset (regresi lama tetap jalan)', () => {
  const D = makeD();
  const ctx = loadSource(['modules/asset/aset-owners.js', 'modules/asset/aset.js', 'modules/asset/aset-reports.js', 'modules/asset/aset-misc.js'], { D, escapeHtml: (s) => String(s) }, ['Aset']);
