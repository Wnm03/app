...
ok(!!version,'current bundle version is numeric');
ok(fs.readFileSync(path.join(root,'sw.js'),'utf8').includes('kw-cache-v'+version),'cache version matches current build');
