...
assert.match(src,/const _editAuditFields=\['categoryId','masterCategoryId','serviceComponentId','serviceJobType','actionType','item','note','foto','checklist','cost','accountId','usedPartId','usedPartQty','catalogPartId','catalogPartQty','catalogPartOemCode','catalogPartLinkedStockId','conditionResult','conditionNote'\]/);
