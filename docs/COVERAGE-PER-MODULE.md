...
Terakhir digenerate: 2026-08-26T11:59:24.963Z
Total file test (`tests/*.test.js`): 448 · Total module family: 19
...
| `modules/shop` | 26 | 61 |  |
| `modules/vehicle` | 80 | 76 |  |
| `root` | 19 | 77 |  |
| `modules/asset` | 21 | 136 |  |
| `modules/finance` | 51 | 187 |  |
| `modules/shared` | 35 | 225 |  |
