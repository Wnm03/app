...
Terakhir digenerate: 2026-09-25T02:02:23.457Z
Total file test (`tests/*.test.js`): 987 · Total module family: 17
...
| `modules/vehicle` | 150 | 250 |  |
| `root` | 20 | 251 |  |
| `modules/finance` | 62 | 294 |  |
| `modules/shared` | 47 | 414 |  |
