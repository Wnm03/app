...
Terakhir digenerate: 2026-09-21T22:57:48.729Z
Total file test (`tests/*.test.js`): 913 · Total module family: 17
...
| `modules/shop` | 26 | 78 |  |
| `modules/asset` | 26 | 194 |  |
| `modules/vehicle` | 131 | 216 |  |
| `root` | 20 | 242 |  |
| `modules/finance` | 62 | 291 |  |
| `modules/shared` | 46 | 391 |  |
