...
Terakhir digenerate: 2026-08-29T08:10:05.047Z
Total file test (`tests/*.test.js`): 469 · Total module family: 19
...
| `modules/shop` | 27 | 62 |  |
| `modules/vehicle` | 81 | 79 |  |
| `root` | 19 | 84 |  |
| `modules/asset` | 22 | 138 |  |
| `modules/finance` | 55 | 199 |  |
| `modules/shared` | 37 | 234 |  |
