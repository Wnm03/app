...
Terakhir digenerate: 2026-09-16T08:36:06.105Z
Total file test (`tests/*.test.js`): 777 · Total module family: 18
...
| `modules/shop` | 26 | 72 |  |
| `modules/vehicle` | 104 | 162 |  |
| `modules/asset` | 26 | 189 |  |
| `root` | 19 | 196 |  |
| `modules/finance` | 59 | 274 |  |
| `modules/shared` | 41 | 329 |  |
